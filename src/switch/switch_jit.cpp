...
bool RunJitSelfTest() {
    AppendJitLog("diagnostics_version=16 buffered_switch_trace=enabled full_jit_cache_maintenance=enabled callback_safe_unmapped_memory=enabled call_free_cycle_budget=enabled thread_local_breadcrumbs=enabled");
