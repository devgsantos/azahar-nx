function(azahar_enable_native_runtime)
    if(TARGET video_core)
        ...
        target_precompile_headers(video_core PRIVATE
            "$<$<COMPILE_LANGUAGE:CXX>:${CMAKE_SOURCE_DIR}/src/video_core/renderer_deko3d/deko3d_native_policy.h>")
    endif()
...
cmake_language(DEFER CALL azahar_enable_native_runtime)
